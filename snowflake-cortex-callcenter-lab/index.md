...
## 2. Create a Snowflake Internal Stage and Upload PDFs  ⏱️ 
~10 minutes
...
* Create a table to hold the raw parsed content:
...
## 4. Best Practices for Prompt Engineering  ⏱️ 
~10 minutes
...
## 5. Convert to JSON Using COMPLETE  ⏱️ 
~15 minutes
...
* Create a table to store structured data:
...
* Add a new column to store translated output:
...
* Add columns for storing sentiment outputs:
...
## 9. Extract Answers Using EXTRACT_ANSWER  ⏱️ 
~5 minutes
...
* Create a table for Q&A storage:
...
## 11. Explore the Cortex Analyst Playground  ⏱️ 
~7 minutes
...
* **Navigate to the Playground**: Visit the  [Cortex Analyst Playground](https://docs.snowflake.com/en/user-guide/snowflake-cortex/llm-playground).
* **Choose a Model**: Select from models like `mistral-7b`, `mixtral-8x7b`, `llama2-70b`, or `claude-3-5-sonnet`.
* **Paste Sample Transcript Text**: Use extracted text from your PDFs (e.g., `RAW_TEXT:content`) as input.
* **Craft Your Prompt**: Use prompts like:
...
[Paste content here]
```
* **Test and Iterate**: Run your prompt and refine it until the model returns your desired structure.
* **Copy Your Prompt**: Use the refined version in your `COMPLETE` function for better consistency.
